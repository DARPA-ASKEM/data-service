"""
builder.fix - The generation of the ORMs and schemas relies on two libraries 'PyDBML' and
...
def create_pipeline(*funcs):
    """
    Compose functions provided as arguments in a primitive fashion
    """
    def stateful_compose(original):
        val = original
        for func in funcs:
            val = func(val)
        return val
